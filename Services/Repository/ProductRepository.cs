...
namespace Services.Repository
{
    public interface IProductRepository
    {
        ...
        List<Apriori.Models.Product> GetAprioriSupports();
    }
    ...
    public class ProductRepository : RepositoryBase, IProductRepository
    {
        ...
        public List<Apriori.Models.Product> GetAprioriSupports()
        {
            var p = new DynamicParameters();
            var res = DbConnect.Query<Apriori.Models.Product>("Proc_Apriori_GetSupports", p, commandType: CommandType.StoredProcedure, transaction: Transaction);
            return res.AsList();
        }
    }
}
